...
object Test : BuildType({
    ...
    params {
        ...
        password("env.JiraApiKey", "credentialsJSON:65ce72ad-aa24-4e93-afd7-dcef25ccc494")
        ...
        powerShell {
            ...
            scriptMode = script {
                content = """
                    ...
                    ${'$'}version = ((cloudsmith list packages -k %CloudsmithApiKey% -F pretty_json diligent/entitiesas | convertfrom-json).data | ? Name -eq 'AdminPortal').version
